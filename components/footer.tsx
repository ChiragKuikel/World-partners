...
function Footer() {
  ...
  const socialMediaLinks = [
    { icon: faFacebookF, url: 'https://www.facebook.com/profile.php?id=61584641173683', label: 'Facebook' },
    { icon: faWhatsapp, url: 'https://wa.me/message/SOMKLHRXGVFGE1', label: 'Whatsapp' },
    { icon: faInstagram, url: 'https://www.instagram.com/worldpartner_', label: 'Instagram' },
    { icon: faLinkedinIn, url: 'https://www.linkedin.com/in/world-partner', label: 'LinkedIn' },
    { icon: faTiktok, url: 'https://www.tiktok.com/@worldpartner', label: 'Tiktok' },
  ];
    ...
    <footer className="w-full py-4" style={{ backgroundColor: primaryColor }}>
      <div className="max-w-full mx-auto px-16">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8 ">
          ...
          <div className="flex-1 space-y-6 text-black flex flex-col justify-center items-center">
            ...
            <div className="space-y-2 w-full text-center">
              <p className="text-gray-700 text-lg">
                ...
                Kumari than galli,{<br />}kalimati 14,Kathmandu Nepal
              </p>
            </div>
            ...
            <div className="space-y-2 w-full text-center">
              <p className="text-gray-700 text-lg">
                ...
                <a
                  href="mailto:info@world-partner.com.np"
                  className="text-gray-700 hover:text-black transition-colors duration-200"
                >
                  info@world-partner.com.np
                </a>
                <br />
                <a
          ...
          {/* Column 2 */}
          <div className="flex-1 space-y-6 text-black max-w-md">
            {/* Row 1: Office Hours */}
            ...
            <div className="space-y-4 ">
              ...
              <div className="space-y-3">
                ...
                {/* Subscribe Button */}
                <button
                  className="w-full px-6 py-4 mt-3 bg-gradient-to-br from-[#2C5A5B] to-[#4C9E9F] text-white font-semibold rounded-lg hover:bg-gray-900 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 focus:ring-offset-white"
                >
                  Subscribe Now
                </button>
              </div>
          ...
          <div className="flex-1 ">
            <div className="space-y-4">
              <a
                href="https://www.facebook.com/profile.php?id=61584641173683"
                target="_blank"
                rel="noopener noreferrer"
                className="block group"
              >
                <div className="relative w-full aspect-square max-w-sm mx-auto overflow-hidden rounded-lg shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                  {/* Placeholder for Facebook page image */}
    
                  <div className="w-full h-full relative">
                    <img
                      src="/fbpage.png"  // Update this path
                      alt="Facebook Page"
                      className="w-full h-full object-cover"
                    />
                    {/* Keep the text overlay on top of the image */}
                    <div className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center p-4 text-white">
                      <h3 className="text-xl font-bold text-white mb-4">Follow us on Facebook</h3>
                      <div className="text-5xl mb-4">f</div>
                      <p className="text-xl font-bold text-center"> on Facebook</p>
                      <p className="text-white/80 font-semibold text-center mt-2">Like us for updates and news</p>
